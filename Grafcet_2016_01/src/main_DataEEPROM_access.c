...
/*
//Declare input pins
# define IN_PIN_0 PORTBbits.RB0	// NB: when PORTBbits.RB0 is modified, IN_PIN_0 is automatically affected
# define IN_PIN_1 PORTBbits.RB1
# define IN_PIN_2 PORTBbits.RB2
# define IN_PIN_3 PORTBbits.RB3
# define IN_PIN_4 PORTBbits.RB4
# define IN_PIN_5 PORTBbits.RB5
# define IN_PIN_6 PORTBbits.RB6
# define IN_PIN_7 PORTBbits.RB7
# define IN_PIN_8 PORTBbits.RB8
# define IN_PIN_9 PORTBbits.RB9
# define IN_PIN_10 PORTBbits.RB10
# define IN_PIN_11 PORTBbits.RB11
# define IN_PIN_12 PORTBbits.RB12 // by NNG
//Declare output pins
# define OUT_PIN_0 PORTFbits.RF0
# define OUT_PIN_1 PORTFbits.RF1
# define OUT_PIN_2 PORTFbits.RF2
# define OUT_PIN_3 PORTFbits.RF3
# define OUT_PIN_4 PORTFbits.RF4
# define OUT_PIN_5 PORTFbits.RF5
# define OUT_PIN_6 PORTFbits.RF6
# define OUT_PIN_7 PORTDbits.RD8

*/

//Map Inputs with INPUT PINs
//Effective number of Inputs for the current system : 3
# define pin_I0 PORTBbits.RB0
# define pin_I1 PORTBbits.RB1
# define pin_I2 PORTBbits.RB2
# define pin_I3 PORTBbits.RB3
# define pin_I4 PORTBbits.RB4
# define pin_I5 PORTBbits.RB5
# define pin_I6 PORTBbits.RB6
# define pin_I7 PORTBbits.RB7
# define pin_I8 PORTBbits.RB8
# define pin_I9 PORTBbits.RB9
# define pin_I10 PORTBbits.RB10
# define pin_I11 PORTBbits.RB11
# define pin_I12 PORTBbits.RB12

//Map Outputs with OUTPUT PINs
//Effective number of Outputs for the current system : 8
# define pin_Q0 PORTFbits.RF0
# define pin_Q1 PORTFbits.RF1
# define pin_Q2 PORTFbits.RF2
# define pin_Q3 PORTFbits.RF3
# define pin_Q4 PORTFbits.RF4
# define pin_Q5 PORTFbits.RF5
# define pin_Q6 PORTFbits.RF6
# define pin_Q7 PORTDbits.RD8
...
//S matrix 
	0x0002, 0x0004, 0x0008, 0x0010, 0x0020, 0x0001, 
//MA matrix 
	0x003C, 0x0027, 0x003C, 0x0002, 0x0001, 0x0027, 0x0010, 0x0008, 
//RS matrix 
	0x0001, 0x8001, 
	0x0001, 0x8002, 
	0x0001, 0x8000, 
...
//From grafcet source File: C:\Users\nzebop\Google Drive\some_g7_examples\g7_test\feu_exemple2.xml
