...
Public Class GraphicalTransitionsList
    ...
    Public Function ExecuteScanCycle() As Boolean
        ...
        For Each T As GraphicalTransition In Me
            ...
            If T.TrySuperable() Then
                'Se almeno una transizione è superabile ExecuteScanCycle restituisce True, cioè....
                '....è cambiato lo stato
    ...
    Public Sub ExecutePreactivationCycle()
        'Se la Condition è Changed preActive e depreActive le Steps....
        '....eseguendo le Actions impulsive la fa se non era stata già preActiveta
        For Each T As GraphicalTransition In Me
            If T.ReadSuperable Then
                ...
                '.... da preActivere se non erano già preattive....
