...
Public MustInherit Class BaseGraphicalCoil
    ...
    Public MustOverride Sub DrawCoil(ByVal DrawSmallRectangels As Boolean)
    ...
    Public Function CeIlMioRetSup(ByVal x As Integer, ByVal y As Integer) As Boolean
        If Abs(x - Position.X) <= CInt(m_Dimension / 10) And Abs(y - (Position.Y - CInt(m_Dimension / 2) - CInt(m_Dimension / 10))) <= (m_Dimension / 10) Then
            CeIlMioRetSup = True
        End If
    End Function
