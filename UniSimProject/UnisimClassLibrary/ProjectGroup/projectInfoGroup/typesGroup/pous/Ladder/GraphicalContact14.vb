...
Public Class GraphicalContact14
    Inherits BaseGraphicalContant
    ...
    Public Overloads Overrides Sub DrawContact(ByVal DrawSmallRectangels As Boolean)
    ...
    Public Overloads Sub Draw(ByVal DrawSmallRectangels As Boolean, ByVal Col1 As Drawing.Color, ByVal Col2 As Drawing.Color, ByVal Col3 As Drawing.Color, ByVal Col4 As Drawing.Color)
        ...
        Try
            ...
            If Monitor.TryEnter(GraphToDraw, 2000) Then
                ...
                GraphToDraw.DrawLine(Penna, Position.X - 20, Position.Y, Position.X - 15, Position.Y)                          'orizz
                GraphToDraw.DrawLine(Penna, Position.X + 15, Position.Y, Position.X + 20, Position.Y)          'orizz
                GraphToDraw.DrawLine(Penna, Position.X - 15, Position.Y + 14, Position.X - 15, Position.Y - 14) 'vert
                GraphToDraw.DrawLine(Penna, Position.X + 15, Position.Y + 14, Position.X + 15, Position.Y - 14) 'vert

                'lettera JMP
                Dim Rect1 As Drawing.SizeF
                Dim testo As String = "JMP"
                ...
                If DrawSmallRectangels Then
                    ...
                    'GraphToDraw.DrawRectangle(Penna, Position.X, Position.Y, larg, alt)
                ...
                If Not IsNothing(m_Name) Then
                    ...
                    If Rect.Width < m_dimension Then
                        GraphToDraw.DrawString(m_Name, Carattere, Br, Position.X - (Rect.Width / 2) + 1, Position.Y - (m_Dimension / 1.3))
                    Else
