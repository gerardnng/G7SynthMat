...
Public Class GraphicalBlock
    Implements IXMLSerializable, IMovableObject, IHasLocalId, IHasName, IFBDConnectable, IDocumentable
    ...
    Public Sub xmlExport(ByRef writer As System.Xml.XmlTextWriter) Implements IXMLExportable.xmlExport
        ...
        writer.WriteAttributeString("instanceName", BoundBlockType)
        ...
        For Each connection As GraphicalFBDConnection In connections
            ...
            If TypeOf (connection.DestinationObject) Is GraphicalBlock Then GoTo CloseBlock
