...
Public Class VariablesListControlPanel
    ...
    Protected m_ChaneTimeSample As Boolean
...
#Region " Codice generato da Progettazione Windows Form "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Panel1.Size = New System.Drawing.Size(492, 188)
        ...
        Me.Button1.Location = New System.Drawing.Point(4, 220)
        ...
        Me.Button2.Location = New System.Drawing.Point(250, 220)
        ...
        Me.TrackBar1.Location = New System.Drawing.Point(406, 228)
        ...
        Me.Label4.Location = New System.Drawing.Point(342, 224)
        ...
        Me.Label1.Location = New System.Drawing.Point(402, 216)
        ...
        Me.Label7.Location = New System.Drawing.Point(450, 216)
...
#End Region
    Private Sub VariablesControlPanel1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = m_List.Name
        m_TimeSample = 100 - TrackBar1.Value
    End Sub
    ...
    Public Sub AddVariableAndControl()
        ...
        If ResultDialog = DialogResult.OK Then
            ...
            If Not IsNothing(m_Lists.FindVariableByName(VariableDialog.m_Name)) Then
                MsgBox("Variable " & VariableDialog.m_Name & " already exist!")
            Else
                'Aggiunge una nuova variabile con il relativo controllo
    ...
    Public Sub SettingVariable(ByRef VC As VariableControl)
        ...
        Dim VariableDialog As New VariableDialogForm
        VariableDialog.m_ChangeType = False

        VariableDialog.m_Name = Var.Name
        VariableDialog.m_Address = Var.Address
        VariableDialog.m_InitialValue = Var.ReadInitialValue
        VariableDialog.m_Type = Var.dataType
        Dim OldName As String = VariableDialog.m_Name
    ...
    Public Sub RemoveVariable(ByRef VC As VariableControl)
        ...
        If MsgBox("Remove variable '" & VC.ReadVariable.Name & "'?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
    ...
    Private Sub OnEndTimer(ByVal Obj As Object)
        If m_ChaneTimeSample Then   'Controlla se deve cambiare il tempo di campionamento
            ChangeSampleTime()
        Else
            For Each C As VariableControl In Panel1.Controls
