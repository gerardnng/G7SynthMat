...
#End Region
    ...
    Private Sub Print()
        ...
        Catch ex As Exception
            MsgBox("Error while printing: " + ex.Message, MsgBoxStyle.Critical, UniSimVersion.VersionInfo.PrintableDescriptionForTool(""))
        Finally
        End Try
    End Sub
    ...
    Private Sub PrintPreview()
        Try
            ...
            End If
        Catch Ex As Exception
            MsgBox("Error while creating preview: " + Ex.Message, MsgBoxStyle.Critical, UniSimVersion.VersionInfo.PrintableDescriptionForTool(""))
        End Try
    End Sub
