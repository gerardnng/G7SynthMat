    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DeviceSettingsButton.Click
        ...
        If ResultDialog = DialogResult.OK Then
            ...
            If m_IOInterface.ConnectDriver(DeviceIDDlg.IdDevice) Then
                ...
                MsgBox("Device tests OK", MsgBoxStyle.Information, UniSimVersion.VersionInfo.PrintableDescriptionForTool())
                'Pronto per il controllo
                UnLockControl()
            Else
                'Il test non è passato
                MsgBox("Device tests failed", MsgBoxStyle.Information, UniSimVersion.VersionInfo.PrintableDescriptionForTool())
                LockControl()
            End If
        End If
    End Sub
    Public Sub ShowControlErrors()
        If m_ControlEngineHandles.ErrorsList.Count > 0 Then
            ...
            For i = 0 To m_ControlEngineHandles.ErrorsList.Count - 1
                Select Case CType(m_ControlEngineHandles.ErrorsList(i), Errors)
                ...
                End Select
            Next i
            MsgBox(ErrorString.ToString, MsgBoxStyle.Critical, UniSimVersion.VersionInfo.PrintableDescriptionForTool())
        End If
    End Sub
