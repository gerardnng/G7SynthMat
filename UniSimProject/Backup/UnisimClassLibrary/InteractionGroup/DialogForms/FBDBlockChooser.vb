Public Class FBDBlockChooser
    ...
    Public Sub New(ByVal plist As Pous)
        ...
        ComboBox1.Items.AddRange(FBDBlocksFactory.ValidBlocks(pList))

    End Sub

    Public Sub New(ByVal plist As Pous, ByVal existingBlock As GraphicalFBDBlock, _
            Optional ByVal useNameEditor As Boolean = False)
        Me.New(plist)
        BlockType = existingBlock.BoundBlockType
