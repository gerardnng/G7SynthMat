...
//RS matrix 
	0x0002, 0xC003, 0x3000, 0x0006, 
	0x0001, 0xE314, 
	0x0001, 0xE414, 
	0x0002, 0xC004, 0x3000, 0x0007, 
	0x0001, 0xE528, 
	0x0002, 0xC004, 0x3000, 0x0008
};
//From grafcet source File: D:\DD2\THESE\aContinuation_Fev2016\ArduinoCompiler_VM_Code\Efficiency_v2\g7s\Group 1\Pour_Validation_1.xml
...
void EEPROM_Write()
{
  Serial.println("Entering IN EEPROM_Werite ... ");
  MatricesDATA_eeprom_adr = 0;
  unsigned int M_size = sizeof(MatricesDATA) /2; //To modify dynamically inside MPLAB
  Serial.print("Matrix_size = "); Serial.println(M_size, DEC);
  
  for(i=0; i<M_size ; i++){
    unsigned int data = MatricesDATA[i];
    writeNextIntInEEPROM(data);
    Serial.print("data "); Serial.print(i); Serial.print(" = "); Serial.println(data, HEX);
  }
}

void EEPROM_Read()
{
  Serial.println("Entering IN EEPROM_Read ");
  MatricesDATA_eeprom_adr = 0;
