/*
Time :	11/08/2016 16:46:34
Generated from the grafcet File: 
	D:\DD2\THESE\aContinuation_Fev2016\ArduinoCompiler_VM_Code\Efficiency_v2\g7s\Group 1\Pour_Validation_3.xml
*/
#include "TimerOne.h" 
/*
//Declare INPUTS pins
...
boolean S7_X = true, S7_X_Old = true;
...
void loop(){
	...
	TR_1 = (!S3_X_Old && S3_X) && VT_1;
	TR_2 = (S3_duration > 20) && VT_2;
	TR_3 = (S4_duration > 20) && VT_3;
	TR_4 = (!S4_X_Old && S4_X) && VT_4;
	TR_5 = (!S3_X_Old && S3_X) && (S5_duration > 40) && VT_5;
	TR_6 = (!S4_X_Old && S4_X) && VT_6;
	TR_7 = (!S4_X_Old && S4_X) && VT_7;
	TR_8 = (!S4_X_Old && S4_X) && S0_X && S1_X && VT_8;
	TR_9 = S4_X && VT_9;
	...
	S1_X = TR_6 || TR_7 || (S1_X_Old && !TR_1);
	S2_X = TR_1 || TR_8 || (S2_X_Old && !TR_4);
	S3_X = TR_3 || (S3_X_Old && !TR_2);
	S4_X = TR_2 || (S4_X_Old && !TR_3);
	S5_X = TR_4 || (S5_X_Old && !TR_5);
	S6_X = (S6_X_Old && !TR_7);
	S7_X = (S7_X_Old && !TR_8) || (S7_X_Old && !TR_9);
	S8_X = TR_9;
