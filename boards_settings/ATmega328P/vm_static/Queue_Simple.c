...
void setup(){
	...
	EEPROM_Read();
	//Always call this function after EEPROM_Read() function to initialize the variables: //N_trans, N_Steps, N_Inputs, N_actions
	init_IO_ports();
	X = X_INIT;
	initializeTimer1(); 
...
unsigned int readNextIntFromEEPROM()
{
	unsigned int val; //variable de type int, vide, qui va contenir le résultat de la lecture
